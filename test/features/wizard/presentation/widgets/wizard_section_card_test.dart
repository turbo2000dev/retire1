...
void main() {
  group('WizardSectionCard', () {
    ...
    group('Status Icons', () {
      testWidgets('shows not started icon when no status provided', (tester) async {
      ...
      testWidgets('shows in progress icon', (tester) async {
        await tester.pumpWidget(buildCard(
          status: WizardSectionStatus.inProgress(),
        ));
      ...
      testWidgets('shows complete icon', (tester) async {
        await tester.pumpWidget(buildCard(
          status: WizardSectionStatus.complete(),
        ));
      ...
      testWidgets('shows skipped icon', (tester) async {
        await tester.pumpWidget(buildCard(
          status: WizardSectionStatus.skipped(),
        ));
      ...
      testWidgets('shows needs attention icon', (tester) async {
        await tester.pumpWidget(buildCard(
          status: WizardSectionStatus.needsAttention([]),
        ));
    ...
    group('Badges', () {
      testWidgets('shows required badge for required sections', (tester) async {
        await tester.pumpWidget(buildCard(
          section: testSection.copyWith(isRequired: true),
        ));

        expect(find.text('Required'), findsOneWidget);
      });

      testWidgets('does not show required badge for optional sections', (tester) async {
        await tester.pumpWidget(buildCard(
          section: testSection.copyWith(isRequired: false),
        ));

        expect(find.text('Required'), findsNothing);
      });

      testWidgets('shows optional badge for educational sections', (tester) async {
        await tester.pumpWidget(buildCard(
          section: testSection.copyWith(isEducational: true),
        ));

        expect(find.text('Optional'), findsOneWidget);
      });

      testWidgets('does not show optional badge for non-educational sections', (tester) async {
        await tester.pumpWidget(buildCard(
          section: testSection.copyWith(isEducational: false),
        ));
    ...
    group('Current Section Indicator', () {
      ...
      testWidgets('does not show chevron for non-current section', (tester) async {
        await tester.pumpWidget(buildCard(isCurrentSection: false));

        expect(find.byIcon(Icons.chevron_right), findsNothing);
      });

      testWidgets('uses primary container color for current section', (tester) async {
        await tester.pumpWidget(buildCard(isCurrentSection: true));
    ...
    group('Suggested Next Indicator', () {
      ...
      testWidgets('does not show Next badge for non-suggested section', (tester) async {
