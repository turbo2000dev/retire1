...
/// Form for creating/editing a retirement event
class RetirementEventForm extends StatefulWidget {
  final RetirementEvent? initialEvent;
  final List<Individual> individuals;
  final ValueChanged<Event?> onChanged;

  const RetirementEventForm({
    super.key,
    this.initialEvent,
  ...
  @override
  State<RetirementEventForm> createState() => _RetirementEventFormState();
}

class _RetirementEventFormState extends State<RetirementEventForm> {
